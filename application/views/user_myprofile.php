			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro" class="mt-0">
						...
						?>
							<img class="logo" style="margin:auto; width:200px; height:200px; object-fit:cover;" src="<?php echo base_url('assets/images/profiles/'.$user->foto_profile) ?>" alt="" />
						<?php
							}
						?>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							...
							<li class="active"><a href="<?php echo base_url('index.php/user/myprofile/'.$user->username) ?>">My Profile</a></li>
				...
				<!-- Main -->
					<div id="main">
						...
						<section class="posts">
							...
							?>
									<article>
										...
										<a href="#" class="image fit"><img src="<?php echo base_url('assets/images/post/photos/'.$feeds->file) ?>" alt="" style="margin:auto; width:200px; height:200px; object-fit:cover;" /></a>
										<p></p>
										<ul class="actions special">
											<li><a href="<?php echo base_url('index.php/user/detil_post/'.$user->username.'/'.$feeds->id_file) ?>" class="button">See post</a></li>
											<li><a href="#" class="button">Edit Post</a></li>
										</ul>
									</article>
							<?php
								endforeach;
						...
						?>
							<article class="post featured">
								<ul class="actions special">
									<button type="button" class="button icon solid solo fas fa-plus" data-toggle="modal" data-target="#add_post">Add Post</button>
									<!-- <li><a href="#" class="button">Add Posting</a></li> -->
								</ul>
							</article>
						<?php
						}
